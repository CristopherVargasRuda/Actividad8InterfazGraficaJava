...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        ...
        this.iIconoUsuario = new ImageIcon("resources/img/usuario_navegacion.png");
        this.iInicio = new ImageIcon("resources/img/inicio.png");
        this.iPerfil = new ImageIcon("resources/img/perfil.png");
        this.iAmigos = new ImageIcon("resources/img/amigos.png");
        this.iProductos = new ImageIcon("resources/img/productos.png");
        this.iConfiguracion = new ImageIcon("resources/img/configuracion.png");
        this.iCerrarSesion = new ImageIcon("resources/img/salir.png");
        this.iImagenUsuario = new ImageIcon("resources/img/perfiles/perfil1.png");
    }
    ...
    public void crearJLabels(){
        ...
        this.lNombreUsuario = sObjGraficos.construirJLabel(
            "Nombre de Usuario", 50, 20, 200, 40, null, Color.WHITE, null, 
        ...
        this.lImagenUsuario = sObjGraficos.construirJLabel(
            null, (this.pSuperior.getWidth()-180)/2, 75, 180, 180, iDimAux, 
                null, null, null, "c"
        );
        ...
        this.lEslogan = sObjGraficos.construirJLabel(
            ...
            null, Color.WHITE, null, sRecursos.getFontPequeña(), "c"
        );
